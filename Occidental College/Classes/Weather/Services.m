...
-(void)updateServices{
	...
	[self updateService: self.oxyWeatherStation];
}
...
-(OxyWeatherStation*)oxyWeatherStation{
	if(oxyWeatherStation == nil) {
		oxyWeatherStation = [[OxyWeatherStation alloc] init];
	}
	return oxyWeatherStation;
}
