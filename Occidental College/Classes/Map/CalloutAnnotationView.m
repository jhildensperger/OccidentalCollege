...
//- (id) initWithAnnotation:(id <MKAnnotation>)annotation andPlace:(Place *)place {
//	if ((self = [super initWithAnnotation:annotation andPlace:place])) {
//        self.place = place;
//		self.enabled = NO;
//		self.backgroundColor = [UIColor clearColor];
//	}
...
- (void)setAnnotation:(id <MKAnnotation>)annotation {
	...
	[self prepareOffset];
//    CLLocationCoordinate2D newCenterCoordinate = {self.annotation.coordinate.latitude, 
...
- (void)drawRect:(CGRect)rect {
	...
	CGContextSetShadowWithColor(context, CGSizeMake (0, self.yShadowOffset), 6, [UIColor colorWithWhite:0 alpha:.6].CGColor);
